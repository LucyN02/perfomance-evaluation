...
public enum BehavioralEnum {
    ...
    LEARN("APRENDE_CONTINUAMENTE", "Você se atualiza e aprende o tempo todo?", 3),
    DATA("USA_DADOS_DECISOES", "Você utiliza dados para tomar suas decisões?", 5),
    AUTONOMY("TRABALHA_AUTONOMIA", "Você trabalha com autonomia?", 3);
